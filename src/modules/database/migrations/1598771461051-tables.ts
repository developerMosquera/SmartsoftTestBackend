...
export class tables1598771461051 implements MigrationInterface {
    name = 'tables1598771461051'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `tableDataUno` (`id` int NOT NULL AUTO_INCREMENT, `T1C1` int NOT NULL DEFAULT 0, `T1C2` varchar(50) NULL DEFAULT NULL, `T1C3` int NOT NULL DEFAULT 0, `T1C4` datetime NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
